...
> {
  ...
  public render(): void {
    let itemId: number, customFormName: string = "";
    ...
    if(this.properties.isApplixForm) {
      customFormName = CONST.ApplixForm.FormName;
    }
    ...
    if (Environment.type === EnvironmentType.Local) {
      ...
      element = React.createElement(ListForm, {
        ...
        showAttachmentField: this.properties.showAttachmentField,
        isApplixForm: this.properties.isApplixForm,
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    ...
    mainGroup.groupFields.push(
      PropertyPaneToggle("showUnsupportedFields", {
        ...
        disabled: !this.properties.listUrl
      }) as IPropertyPaneField<any> // for some reason the PropertyPaneToggle was not being accepted as IPropertyPaneField<any>
    );
    mainGroup.groupFields.push(
      PropertyPaneToggle("showAttachmentField", {
        label: strings.ShowAttachmentFieldLabel,
        disabled: !this.properties.listUrl
      }) as IPropertyPaneField<any>
    );
    mainGroup.groupFields.push(
      PropertyPaneToggle("isApplixForm", {
        label: strings.IsApplixForm,
        disabled: !this.properties.listUrl
      }) as IPropertyPaneField<any>
    );
    mainGroup.groupFields.push(
